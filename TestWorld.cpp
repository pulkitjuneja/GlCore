...
public:
	...
	bool init() {
		...
		scene->createPointLight(glm::vec4(-20, 10, 5, 1.0), glm::vec4(0.3f, 0.01, 0.01, 1.0), glm::vec4(1, 0, 0, 1.0), glm::vec4(1, 0, 0, 1.0));
		scene->createPointLight(glm::vec4(20, 10, 5, 1.0), glm::vec4(0.3f, 0.01, 0.01, 1.0), glm::vec4(0, 1, 0, 1.0), glm::vec4(0, 1, 0, 1.0));
